...
public class RabbitMQConfig {
    ...
    public static final String ENRICHMENT_QUEUE = "q.enrichment.greenhouse-created";
    public static final String ENRICHMENT_DLQ = "q.enrichment.greenhouse-created.dlq";
    ...
    // Очередь для greenhouse.created
    // Только события создания теплиц — binding key "greenhouse.created" (не "#")
    ...
    /**
     * Привязка, только greenhouse.created и очередь enrichment.
     * В отличие от audit-service (binding "#" — все события),
     * enrichment-клиент подписан только на создание теплиц.
     */
    @Bean
    public Binding enrichmentBinding(Queue enrichmentQueue, TopicExchange eventsExchange) {
        return BindingBuilder
                ...
                .to(eventsExchange)
                .with(RoutingKeys.GREENHOUSE_CREATED); // только greenhouse.created
    }
