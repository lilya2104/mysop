 ...
 * - Для async используется GreenhouseAnalyticsGrpc.newFutureStub() или newStub()
 *
...
public class GrpcClientConfig {
    ...
    /**
     * BlockingStub — синхронный клиент для вызова BookAnalytics.AnalyzeBook().
     *
     ...
     */
    @Bean
    public GreenhouseAnalyticsGrpc.GreenhouseAnalyticsBlockingStub bookAnalyticsStub(ManagedChannel channel) {
        return GreenhouseAnalyticsGrpc.newBlockingStub(channel);
    }
